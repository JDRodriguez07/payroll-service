package com.app.payroll_service.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("API de Gestión de Nómina") // Título de la API
                        .version("1.0") // Versión de la API
                        .description("API para la gestión de nómina desde el área de recursos humanos"));
    }
}